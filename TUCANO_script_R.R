...
diretorio_trabalho <- "C:/Users/Victor Felipe/Desktop/Doutorado/WEBSCRAPING/analise/" # >>>>> EDITE APENAS ESTA LINHA <<<<<
...
caminho_arquivo <- "C:/Users/Victor Felipe/Desktop/Doutorado/WEBSCRAPING/analise/conteudo_global.csv"
...
filtro_media <- "uol.com.br"

# 3.2 Parâmetros gerais de análise (ajuste se desejar)
{min_termfreq_unigram <- 50   # Frequência mínima para definir termos mais frequentes
...
############################################################
# 10. COLLOCATIONS (COM E SEM STOPWORDS)
############################################################
...
# 10.2 Collocations “filtradas” (sem stopwords, mais técnicas)
...
palavras_busca <- c("mil", "casos")   # <-- ALTERE AQUI conforme desejar
